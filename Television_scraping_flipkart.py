#BeautifulSoup is a library that used for web scraping purposes to pull the data out of HTML and XML files. 
...
products_url="https://www.flipkart.com/search?q=televisions&sid=ckf%2Cczl&as=on&as-show=on&otracker=AS_QueryStore_OrganicAutoSuggest_1_7_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_7_na_na_na&as-pos=1&as-type=RECENT&suggestionId=televisions%7CTelevisions&requestId=17fcc630-9e30-4658-a084-576085aab198&as-searchtext=televis"
...
products_df.to_csv('tvproducts.csv')